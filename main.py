...
async def main():
    global score, ground_scroll, flying, flying2, game_over, game_over2
    global pass_pipe_bird_1, pass_pipe_bird_2, flappy_countdown, flappy2_countdown
    global revive_count, last_pipe
## game 
    while True:
        #draw
